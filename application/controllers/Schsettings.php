...
class Schsettings extends Admin_Controller
{
    ...
    public function saveidautogeneration()
    {
        ...
        if ($this->input->post('sroll_auto_insert')) {
            $this->form_validation->set_rules('sroll_prefix', $this->lang->line('roll_no_prefix'), 'trim|required|xss_clean');
            $this->form_validation->set_rules('sroll_start_from', $this->lang->line('roll_start_from'), 'trim|integer|required|xss_clean');
            $this->form_validation->set_rules('sroll_no_digit', $this->lang->line('roll_no_digit'), 'trim|integer|required|xss_clean|callback_check_sroll_digit');
        }
