...
class Site extends Public_Controller
{
    ...
    public function login()
    {
        ...
        // if ($this->captchalib->is_captcha('login')) {
            ...
            //     $this->form_validation->set_rules('g-recaptcha-response', $this->lang->line('captcha'), 'trim|required');
            // }else{
            //     $this->form_validation->set_rules('g-recaptcha-response', $this->lang->line('captcha'), 'trim|required');
            // }
            ...
            // $secret_key = '6LerqigqAAAAAJU7ZC8BeD-Ef_bH0WELpWySRYma'; // Replace with your Secret Key
            // $response = file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=$secret_key&response=$recaptcha_response");
            // $response_keys = json_decode($response, true);
        
            // if(intval($response_keys["success"]) !== 1) {
            //     // Verification failed
            //     // Handle error (e.g., send error message to front end)
            //     $this->session->set_flashdata('recaptcha_error', 'reCAPTCHA verification failed. Please try again.');
            //     // redirect('your_login_page'); // Adjust as necessary
