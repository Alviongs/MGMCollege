...
class Customfield extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('lengthid', $this->lang->line('length_name'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'length'           => $this->input->post('lengthid'),
            );
    ...
    public function edit($id)
    {
        ...
        $this->form_validation->set_rules('length', $this->lang->line('length_name'), 'trim|required|xss_clean');
