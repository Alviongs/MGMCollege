...
class Internalresult extends Admin_Controller
{
    ...
    public function search()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $stidd=$this->publicresultsubjectgroup_model->getadstudentid($admino);
            ...
            $resultdata = $this->publicresultsubjectgroup_model->getadstudentresults($admino,$resulttype,$academicid);
