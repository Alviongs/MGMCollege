                        ...
                        <div class="box-body table-responsive overflow-visible">
                            ...
                            <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                ...
                                <div class="balance-wrapper">
                                    <div>
                                        <h4><b>Opening Balance : </b><?php echo $currency_symbol . amountFormat(($openaccountbalance)); ?> </h4>
                                    </div>
                                    <div>
                                        <h4><b>Closing Balance : </b><?php echo $currency_symbol . amountFormat(($closeaccountblance)); ?></h4>
                                    </div>
                                </div>
