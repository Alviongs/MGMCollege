            ...
            if ($this->rbac->hasPrivilege('fees_type', 'can_add') || $this->rbac->hasPrivilege('fees_type', 'can_edit')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form action="<?php echo site_url("admin/accounttype/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('account_type_code'); ?></label> <small class="req">*</small>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('account_type_code'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_type', 'can_edit')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/accounttype/edit/<?php echo $feetype['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_type', 'can_delete')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/accounttype/delete/<?php echo $feetype['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
