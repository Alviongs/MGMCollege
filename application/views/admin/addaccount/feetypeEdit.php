                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_account_type'); ?></h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo site_url("admin/addaccount/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="name" name="name" type="text" class="form-control"  value="<?php echo set_value('name', $feetype['name']); ?>" />
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>
                                
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('accountcode'); ?></label> <small class="req">*</small>
                                    <input id="code" name="code" type="text" class="form-control"  value="<?php echo set_value('name', $feetype['code']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="accountcategory_id" name="accountcategory_id" class="form-control" >
                                        ...
                                        foreach ($feegroupList as $feegroup) {
                                            ...
                                            if (set_value('accountcategory_id',$feetype['account_category']) == $feegroup['id']) {
                                ...
                                <div class="form-group">
                                    ...
                                    <select  id="section_id" name="section_id" class="form-control" >
                                        <option value="<?php echo $feetype['account_type']; ?>"><?php echo $feetype['type']; ?></option>
                                    </select>
                                    ...
                                    <select class="form-control" name="gender">
                                        ...
                                        <?php
                                            ...
                                            <option value="<?php echo $key; ?>" <?php
                                                if (set_value('gender',$feetype['account_role']) == $key) {
                                                        echo "selected";
                                                    }
                                ...
                                <!-- <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('paymentmodes'); ?></label><small class="req"> *</small>

                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="cash" <?php if($feetype['cash']==1){echo 'checked';}?> <?php echo set_checkbox('sections[]', "cash"); ?>>Cash<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="cheque" <?php if($feetype['cheque']==1){echo 'checked';}?> <?php echo set_checkbox('sections[]', "cheque"); ?>>Cheque<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="dd" <?php if($feetype['dd']==1){echo 'checked';}?> <?php echo set_checkbox('sections[]', "dd"); ?>>DD<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="bank" <?php if($feetype['bank']==1){echo 'checked';}?> <?php echo set_checkbox('sections[]', "bank"); ?>>Bank<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="transfer"<?php if($feetype['bank_transfer']==1){echo 'checked';}?> <?php echo set_checkbox('sections[]', "transfer"); ?>>Transfer<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="upi" <?php if($feetype['upi']==1){echo 'checked';}?><?php echo set_checkbox('sections[]', "upi"); ?>>UPI<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="card"<?php if($feetype['card']==1){echo 'checked';}?> <?php echo set_checkbox('sections[]', "card"); ?>>Card<label></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="cash" <?php echo $feetype['cash'] == 1 ? 'checked' : ''; ?>>Cash<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="cheque" <?php echo $feetype['cheque'] == 1 ? 'checked' : ''; ?>>Cheque<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="dd" <?php echo $feetype['dd'] == 1 ? 'checked' : ''; ?>>DD<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="bank_transfer" <?php echo $feetype['bank_transfer'] == 1 ? 'checked' : ''; ?>>Bank Transfer<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="upi" <?php echo $feetype['upi'] == 1 ? 'checked' : ''; ?>>UPI<label></div>
                                    <div class="checkbox"><label><input type="checkbox" name="sections[]" value="card" <?php echo $feetype['card'] == 1 ? 'checked' : ''; ?>>Card<label></div>
