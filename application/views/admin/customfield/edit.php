...
$count++;
    ...
    ?>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('length_name'); ?>
                                    <input id="length" name="length" min="2" placeholder="" type="number" class="form-control"  value="<?php echo set_value('length', $cus_field->length); ?>" />
