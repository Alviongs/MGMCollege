                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/customfield') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('length_name'); ?></label> <small class="req">*</small>
                                    <input id="lengthid" name="lengthid" placeholder="" type="number" class="form-control"  value="<?php echo set_value('lengthid'); ?>" />
                                    <span class="text-danger"><?php echo form_error('lengthid'); ?></span>
                                </div>
