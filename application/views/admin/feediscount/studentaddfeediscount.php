                                                    ...
                                                    <div class="btn-group">
                                                      ...
                                                      <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?>
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" data-group="<?php echo ($fee_value->is_system) ? $this->lang->line($fee_value->name). " (" . $this->lang->line($fee_value->type) . ")" : $fee_value->name. " (" . $fee_value->type . ")"; ?>"  data-type="<?php echo ($fee_value->is_system) ? $this->lang->line($fee_value->type) : $fee_value->code; ?>"
                                                                ...
                                                                title="<?php echo $this->lang->line('add_discount'); ?>" data-toggle="modal" data-target="#myFeesModal" data-fee-category="fees"  data-trans_fee_id="0"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal balanceformpopup">
                    <div class="box-body">
                        ...
                        <input  type="hidden" class="form-control" id="stid" value="<?php echo $student["id"]; ?>" readonly="readonly"/>
                        <input  type="hidden" class="form-control" id="certificate_id" value="<?php echo $student["fees_discount_id"]; ?>" readonly="readonly"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-9">
                                <input type="hidden" autofocus="" class="form-control modal_amount" id="amount" value="0"  >
                                <span class="text-danger" id="amount_error"></span>
                            </div>
                        </div>
                        <!-- <div class="form-group">
                            <div class="col-sm-9">
                                <select hidden class="form-control modal_discount_group" id="discount_group">
                                    <option hidden value=""><?php echo $this->lang->line('select'); ?></option>
                                </select>
                                <span class="text-danger" id="amount_error"></span>
                            </div>
                        </div> -->
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="text" disabled class="form-control" id="amount_discount"  value="<?php echo $discountamt;?>">
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="hidden" class="form-control" id="amount_fine" value="0">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn cfees save_button" id="load" data-action="collect" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"> <?php echo $currency_symbol; ?> <?php echo $this->lang->line('add_discount'); ?> </button>
            </div>
        </div>
    </div>
</div>
...
<!--        var student_fees_discount_id = $('#discount_group').val();-->
        ...
        // Perform an AJAX call to addstudentfee
<!--        $.ajax({-->
...
<!--                    console.log(certificateId);-->
                    ...
                    // Perform another AJAX call to approvalsingle
<!--                    $.ajax({-->
...
<!--</script>-->
 ...
 <script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url("studentfee/addstudentdiscountfee") ?>',
            type: 'post',
            data: {
                action: action,
                student_session_id: student_session_id,
        ...
        // Display individual form validation errors
                    $.each(response.error, function(key, value) {
                        alert(key + ': ' + value); // Alert each validation error
                    });
                }
