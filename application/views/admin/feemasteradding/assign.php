        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/feemasteradding/assign/' . $id) ?>" method="post" class="row">
                    ...
                    <form method="post" action="<?php echo site_url('admin/feemasteradding/addfeegroup') ?>" id="assign_form">
                        <?php
                        if (isset($resultlist)) {
                            ?>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                                        ...
                                                                        <tr class="mailbox-name">
                                                                            <td>
                                                                                <input type="hidden" name="fee_group_type_id[]" value="<?php echo $feetype_value->id; ?>">
                                                                                <?php echo $feetype_value->code; ?>
                                                                            </td>
                                                                            <td class="text-right">
                                                                            <input id="amount" name="amount[]" placeholder="Amount" type="text" class="form-control"
