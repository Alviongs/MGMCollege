            ...
            <?php if ($this->rbac->hasPrivilege('fees_master', 'can_add') || $this->rbac->hasPrivilege('fees_master', 'can_edit')) { ?>
                <div class="col-md-3">
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url("admin/halltickectgeneration/subgroupcomboedit/" . $feegroup_type['id']) ?>"  id="feemasterform" name="feemasterform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select autofocus="" id="fee_groups_id" name="fee_groups_id" class="form-control" >
                                                ...
                                                foreach ($feegroupList as $feegroup) {
                                                    ...
                                                    if (set_value('fee_groups_id', $feegroup_type['grpid']) == $feegroup['id']) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  id="feetype_id" name="feetype_id" class="form-control" >
                                                ...
                                                foreach ($feetypeList as $feetype) {
                                                    ...
                                                    if (set_value('feetype_id', $feegroup_type['subid']) == $feetype['id']) {
                                                        echo "selected =selected";
                                                    }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="due_date date" name="due_date" placeholder="" type="text"
                                                class="form-control date" value="<?php echo set_value('due_date', $this->customlib->dateformat($feegroup_type['date'])); ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group"> 
                                                <input type="text"  name="start_time" class="form-control start_time time" id="start_time" value="<?php echo set_value('start_time', $feegroup_type['starttime']); ?>" aria-invalid="false">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group"> 
                                                <input type="text" name="end_time" class="form-control end_time time" id="end_time" aria-invalid="false" value="<?php echo set_value('end_time', $feegroup_type['endtime']); ?>">
                                                <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="max_marks" name="max_marks" placeholder="" type="number"
                                                class="form-control" value="<?php echo set_value('max_marks', $feegroup_type['maxmark']); ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="min_marks" name="min_marks" placeholder="" type="number"
                                                class="form-control" value="<?php echo set_value('min_marks', $feegroup_type['minmark']); ?>" />
