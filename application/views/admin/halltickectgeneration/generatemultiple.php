           ...
           <table cellpadding="0" cellpadding="0" width="90%" align="center" style="background: #fff;padding: 5px 5px;display: block;width: 90%;margin:0 auto">
                <tr>
                    <td valign="top">
                        ...
                        <?php if($sch_setting[0]['student_barcode'] == 1) { ?>
                        <div class="signature"><img src="<?php echo $this->media_storage->getImageURL($student->barcode); ?>" width="150" height="24" style="width: 150px;" /></div>
                        <?php } ?>
                        ...
                        <td valign="top">
                            <div class="staround">
                                <div class="cardleft">
                                    ...
                                    <div class="barcodeimg"><img src="<?php echo $this->media_storage->getImageURL($student->barcode); ?>" width="80" height="24" style="width: 80px; height:24px" /></div>
                                </div><!--./cardleft-->                                
