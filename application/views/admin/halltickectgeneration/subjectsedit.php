            ...
            if ($this->rbac->hasPrivilege('student_categories', 'can_add') || $this->rbac->hasPrivilege('student_categories', 'can_edit')) {
                ...
                <div class="col-md-4">              
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/halltickectgeneration/subedit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">   
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="subjectcode" name="subjectcode" placeholder="" type="text" class="form-control"  value="<?php echo set_value('subjectcode', $category['subject_code']); ?>" />
                                        ...
                                        <tr>                                         
                                            ...
                                            <td align="right" class="mailbox-date">
                                                ...
                                                if ($this->rbac->hasPrivilege('student_categories', 'can_edit')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/halltickectgeneration/subedit/<?php echo $category['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('student_categories', 'can_delete')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/halltickectgeneration/subdel/<?php echo $category['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
