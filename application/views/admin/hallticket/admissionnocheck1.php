        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form  action="<?php echo site_url('admin/hallticket/admino/search') ?>" method="post" class="class_search_form">
           ...
           data: form_data, // serializes the form's elements.
              ...
              success: function(response) { // your success handler
                if(!response.status){
                    ...
                    initDatatable('student-list','admin/hallticket/admino/ajaxSearch',response.params,[],100);
                }
              },
