                ...
                <div class="box box-info" style="padding:5px;">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">
                            <a href="<?php echo site_url('admin/hallticket/hallticketimport/exportformat') ?>">
                    ...
                    <form action="<?php echo site_url('admin/hallticket/hallticketimport/import') ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
