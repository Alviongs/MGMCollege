...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>loginpage/style.css">
</head>
...
<body>
  ...
  <div class="login-container">
    ...
    <form method="POST" class="form login" action="<?php echo site_url('site/login') ?>">
      <div class="form__field form__field--email">
        ...
        <div class="form__input-wrapper">
          <input id="login__email" type="text" name="username" class="form__input" placeholder="Username"
      ...
      <div class="login-actions-container">
        ...
        <a class="forgot-password" href="<?php echo site_url('site/forgotpassword') ?>">Forgot Password?</a>
  ...
  <script src="<?php echo base_url(); ?>loginpage/script.js"></script>
</body>
