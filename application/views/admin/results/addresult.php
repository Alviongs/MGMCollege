            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('adding_internal_results'); ?></h3>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <form role="form" action="<?php echo site_url('admin/results/addresult/search') ?>" method="post" class="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($status) {?>
                                                            <td>
                                                                ...
                                                                <a class='btn btn-info btn-xs admi_no_view' onclick="resultview('<?php echo $this->customlib->getFullName($student['firstname'],$student['middlename'],$student['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?>','<?php echo $student['id']; ?>')" data-target="#myAdmiviewModal" data-student_id="<?php echo $student['id']; ?>" data-student_name="<?php echo $this->customlib->getFullName($student['firstname'],$student['middlename'],$student['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?>" ><i class='fa fa-reorder'></i></a>

                                                                <a class='btn btn-info btn-xs admi_no_edit'  onclick="resultediting('<?php echo $this->customlib->getFullName($student['firstname'],$student['middlename'],$student['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?>','<?php echo $student['id']; ?>')" data-target="#myAdmiEditModal" data-student_id="<?php echo $student['id']; ?>" data-student_name="<?php echo $this->customlib->getFullName($student['firstname'],$student['middlename'],$student['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?>"><i class='fa fa-pencil'></i></a>
...
<script type="text/javascript">
    ...
    function add_result_edit(stid){
        ...
        for (var i = 0; i < subjectsData.length; i++) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/results/addresult/resulteditdata',
                type: "POST",
    ...
    function viewpiont(stid){
        ...
        var resid = <?php echo $result_id;?>
            ...
            // for (var i = 0; i < subjectsData.length; i++) {
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/results/addresult/viewpionts',
                    type: "POST",
                    data:{
                        resulttype_id:resid,
                        subjectidd:stid,
    ...
    function add_pickuppoint(){
        ...
        for (var i = 0; i < subjectsData.length; i++) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/results/addresult/addmore_point',
                type: "POST",
                data:{delete_string:makeid(8),
                      subjectsData:subjectsData[i],
                    },
    ...
    $("#form1").on('submit', (function (e) {
        ...
        $.ajax({
            url: base_url+"admin/results/addresult/create",
            type: "POST",
    ...
    $("#form2").on('submit', (function (e) {
        ...
        var inps = document.getElementsByName('lessons[]');
        $.ajax({
            url: base_url+"admin/results/addresult/update",
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
