        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo site_url('admin/results/resultreports/interexamsearch'); ?>" method="post" class="">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo form_error('student'); ?> <?php echo $this->lang->line('internal_exam_result_report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive overflow-visible">
                            <div class="download_label"><?php echo $this->lang->line('internal_exam_result_report') . " " .
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <?php 
                                            $subjectslist = $this->examtype_model->subjlist($examm,$subjectt);
                                        ...
                                        ?>
                                            ...
                                            <?php if($examstatuss){
                                                ...
                                                if($examstatuss==='fail'){
                                                    ...
                                                    $failstatus = $this->examtype_model->getsinglestudentresultstatus($student['id'],$examm,$subjectt);
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                        $signleresult = $this->examtype_model->getsinglestudentresult($student['id'],$examm,$subjectt);
...
<script type="text/javascript">
    ...
    function  getsubjects(exam_id){
        if (exam_id != "") {
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/results/resultreports/getsubjects",
