        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/results/addpublicresult/assign/' . $id) ?>" method="post" class="row">
                    ...
                    <form method="post" action="<?php echo site_url('admin/results/addpublicresult/addresultgroup') ?>" id="assign_form">
                        <?php
                        if (isset($resultlist)) {
                            ?>
                                        ...
                                        <div class="">
                                            <div class="col-md-4">
                                                <div class="table-responsive">
                                                        ...
                                                        <h4 class="mt2">
                                                            <input type="hidden" name="fee_session_groups" value="<?php echo $id; ?>">
                                                        ...
                                                        <table class="table">
                                                            <thead>
                                                                ...
                                                                <th class="text-right"><?php echo $this->lang->line('min_marks');?></th>
                                                                <th class="text-right"><?php echo $this->lang->line('max_marks');?></th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    foreach ($subjectlist as $feetype_key) {
                                                                        ?>
                                                                        <tr class="mailbox-name">
                                                                            <td>
                                                                                <?php echo $feetype_key['examtype']; ?>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <?php echo $feetype_key['minmarks']; ?>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                <?php echo $feetype_key['maxmarks']; ?>
                                                                            </td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                            ...
                                                            if (empty($resultlist)) {
                                                                ...
                                                                foreach ($resultlist as $student) {
                                                                    ...
                                                                    <tr>
                                                                        <td> 
                                                                            <?php
                                                                            if ($student['assign_status'] != 0) {
                                                                                $sel = "checked='checked'";
                                                                            } else {
                                                                                $sel = "";
                                                                            }
                                                                            ?>
                                                                            <input class="checkbox" type="checkbox" name="student_session_id[]"  value="<?php echo $student['stid']; ?>" <?php echo $sel; ?>/>
                                                                            <input type="hidden" name="student_fees_master_id_<?php echo $student['stid']; ?>" value="<?php echo $student['assign_status']; ?>">
                                                                            <input type="hidden" name="student_ids[]" value="<?php echo $student['stid']; ?>">
                                                                        </td>
