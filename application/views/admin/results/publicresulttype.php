                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('public_result_type'); ?></h3>
                        </div> 
                        <form id="form1" action="<?php echo site_url('admin/results/publicexamtype/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                <?php 
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('public_result_type'); ?></th>
