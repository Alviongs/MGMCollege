            ...
            <?php
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/results/resultsubjectgroup') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                            ...
                                            <?php if($subjectgroup->group_subject){?>
                                                <tr>
                                                    ...
                                                    <td class="mailbox-date pull-right no_print">
                                                        ...
                                                        <a data-placement="top" href="<?php echo base_url(); ?>admin/results/addpublicresult/assign/<?php echo $subjectgroup->id; ?>"
