        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/results/addresult/assign/' . $id) ?>" method="post" class="row">
                    ...
                    <form method="post" action="<?php echo site_url('admin/results/addresult/addresultgroup') ?>" id="assign_form">
                        <?php
                        if (isset($resultlist)) {
                            ?>
