        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/results/resulttype/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('result_type'); ?></label>
