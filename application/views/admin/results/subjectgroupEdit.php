            ...
            <?php
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/results/subjectgroup/edit/' . $subjectgroup[0]->id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    foreach ($subjectlist as $subject) {
                                       ...
                                       <?php 
                                        $marksdata= $this->resultsubjectgroup_model->getmarks($id,$subject['id']);
                                       ?>
