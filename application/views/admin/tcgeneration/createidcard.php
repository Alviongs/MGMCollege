                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/tcgeneration/create') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_nationality" name="tc_nationality" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_nationality'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_optional_lang" name="tc_optional_lang" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_optional_lang'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_second_year_course" name="tc_second_year_course" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_second_year_course'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_eligible_university_course" name="tc_eligible_university_course" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_eligible_university_course'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_receipt_scholarship" name="tc_receipt_scholarship" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_receipt_scholarship'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_receipt_concession" name="tc_receipt_concession" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_receipt_concession'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="tc_date_left" name="tc_date_left" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('tc_date_left', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="tc_punishment_during_period" name="tc_punishment_during_period" placeholder="" type="text" class="form-control" value="<?php echo set_value('tc_punishment_during_period'); ?>" />
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_mother_tongue" name="is_active_mother_tongue" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_mother_tongue', '1', (set_value('is_active_mother_tongue') == 1) ? TRUE : FALSE); ?>>
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('tc_name'); ?></th>
                                        ...
                                        foreach ($idcardlist as $idcard) {
                                            ...
                                            <tr>
                                                <td class="mailbox-name">                                               
                                                    ...
                                                    <a data-id="<?php echo $idcard->id ?>" class="btn btn-default btn-xs view_data"  data-toggle="tooltip" ><?php echo $idcard->tc_name; ?></a>                             
                                                </td>
                                                <td class="mailbox-name">
