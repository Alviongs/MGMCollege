        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/tcgeneration/search') ?>" method="post" class="">
...
if (isset($resultlist)) {
    ?>
                        <form method="post" action="<?php echo base_url('admin/tcgeneration/generatemultiple') ?>">
                            <div  class="" id="duefee">
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length == 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/tcgeneration/generatemultiple") ?>',
                    type: 'post',
                    dataType: "html",
