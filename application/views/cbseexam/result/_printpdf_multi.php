...
foreach ($exam_term_exam_assessment as $assess_key => $assess_value) {
 ...
 $terms_weight_array[]=$assess_value['cbse_term_name']." (".$assess_value['cbse_term_weight'].")";
  ?>
 <td valign="middle" class="text-center" colspan="<?php echo $term_colspan+2; ?>"><?php echo $assess_value['cbse_term_name']." (".$assess_value['cbse_term_code'].")"; ?>
 ...
 ?>              
              <td valign="middle" class="text-center" colspan="3">   
               <?php 
               //term merge array              
