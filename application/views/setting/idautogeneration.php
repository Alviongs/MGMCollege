                            ...
                            <div class="box-body"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <h4 class="session-head"><?php echo $this->lang->line('student_roll_no_auto_generation'); ?></h4>
                                        
                                    </div><!--./col-md-12-->

                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-3"><?php echo $this->lang->line('auto_roll_no'); ?></label>
                                            <div class="col-sm-9">
                                                <label class="radio-inline">
                                                    <input type="radio" name="sroll_auto_insert" value="0" <?php
                                                    if ($result->sroll_auto_insert == 0) {
                                                        echo "checked";
                                                    }
                                                    ?>  ><?php echo $this->lang->line('disabled'); ?>
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="sroll_auto_insert" value="1" <?php
                                                    if ($result->sroll_auto_insert == 1) {
                                                        echo "checked";
                                                    }
                                                    ?> ><?php echo $this->lang->line('enabled'); ?>
                                                </label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-3"><?php echo $this->lang->line('roll_no_prefix'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="sroll_prefix" id="sroll_prefix" class="form-control" value="<?php echo $result->sroll_prefix; ?>">
                                                <span class="text-danger"><?php echo form_error('sroll_prefix'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <span class="text-danger"><?php echo form_error('sroll_no_digit'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-3"><?php echo $this->lang->line('roll_start_from'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="sroll_start_from" id="sroll_start_from" class="form-control" value="<?php echo $result->sroll_start_from; ?>">
                                                <span class="text-danger"><?php echo form_error('sroll_start_from'); ?></span>
                                            </div>
                                        </div>
                                    </div> 
