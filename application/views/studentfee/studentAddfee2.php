                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="text-danger" id="addingaccountname"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.adding_save_button', function (e) {
        ...
        console.log("Form Data:", adding_action, feetype, adding_date, adding_student_session_id, adding_amount, adding_amount_discount, adding_amount_fine, adding_description, adding_parent_app_key, adding_guardian_phone, adding_guardian_email, adding_student_fees_master_id, adding_fee_groups_feetype_id, adding_transport_fees_id, adding_fee_category, adding_payment_mode, adding_student_fees_discount_id);
