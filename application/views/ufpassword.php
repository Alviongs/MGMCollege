        ...
        <div class="max-w-464-px mx-auto w-100">
            ...
            <?php echo $this->customlib->getCSRF(); ?>
                <div class="icon-field">
                    ...
                    <input type="text" name="username" placeholder="<?php echo $this->lang->line('email'); ?>" class="form-control h-56-px bg-neutral-50 radius-12" id="form-username">
                    

                    <!-- <input type="email" name="email" placeholder="<?php echo $this->lang->line('email'); ?>" class="form-control h-56-px bg-neutral-50 radius-12" id="form-username"> -->
                ...
                <div class="form-group">
                    <label class="text-primary-600 fw-bold mt-24">
                          <input class="form-check-input" type="radio" value="student" name="user[]" id="radio1" <?php echo set_radio('user[]', 'student'); ?>>
                          <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio1"> <?php echo $this->lang->line('student'); ?> </label>
                            
                        <!-- <input  name="user[]" type="radio" value="student" <?php echo set_radio('user[]', 'student'); ?>>
                        <?php echo $this->lang->line('student'); ?> -->
                    </label>
                    <label class="text-primary-600 fw-bold mt-24">
                          <input class="form-check-input" name="user[]" type="radio" value="parent" name="radio1" id="radio1" <?php echo set_radio('user[]', 'parent'); ?>>
                          <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio1"> <?php echo $this->lang->line('parent'); ?> </label>
                ...
                <div class="text-center">
                    <a href="<?php echo site_url('site/login') ?>" class="text-primary-600 fw-bold mt-24">Back to Sign In</a>
                </div>
                
                <div class="mt-120 text-center text-sm">
                    <p class="mb-0">Already have an account? <a href="<?php echo site_url('site/login') ?>" class="text-primary-600 fw-semibold">Sign In</a></p>
                </div>
            </form>
        </div>
    </div>
