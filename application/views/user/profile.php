    ...
    <section class="content">
        ...
        foreach ($unread_notifications as $notice_key => $notice_value) {
            ...
            <div class="dashalert alert alert-success alert-dismissible" role="alert">
                <button type="button" class="alertclose close close_notice stualert" data-dismiss="alert" aria-label="Close"
       ...
       ?>" alt="User profile picture">
                            ...
                            <?php if ($sch_setting->roll_no) { ?>
                                <h5 class="widget-user-desc"><?php echo $this->lang->line('roll_number'); ?> <span
                                        class="text-aqua"><?php echo $student['roll_no']; ?></span></h5>
                            <?php } ?>
                        </div>
                    </div>
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item border0">
                                <b><?php echo $this->lang->line('class'); ?></b> <a
                                    class="pull-right text-aqua"><?php echo $student['class'] . ' (' . $student['session'] . ')'; ?></a>
                            </li>
                            ...
                            <li class="list-group-item">
                                <b><?php echo $this->lang->line('gender'); ?></b> <a class="pull-right text-aqua">
                                    <?php echo $this->lang->line(strtolower($student['gender'])); ?></a>
                            </li>
                                ...
                                <li class="list-group-item listnoback">
                                    ...
                                    <?php if (file_exists("./uploads/student_id_card/barcodes/" . $student['admission_no'] . ".png")) { ?>
                                        <a class="pull-right text-aqua">
                                            <img src="<?php echo base_url('uploads/student_id_card/barcodes/' . $student['admission_no'] . '.png'); ?>"
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#documents" data-toggle="tab" aria-expanded="true">
                        ...
                        if ($this->studentmodule_lib->hasActive('student_timeline')) {
                            if ($this->studentmodule_lib->hasActive('student_timeline', 'can_view')) {
                                ?>
                        <li class=""><a href="#timeline" data-toggle="tab" aria-expanded="true">
                        ...
                        if ($sch_setting->student_profile_edit) {
                            ?>
                        <li class="pull-right">
                            <a href="<?php echo site_url('user/user/edit') ?>" data-toggle="tooltip"
                        ...
                        <div class="tab-pane active" id="activity">
                            ...
                            <div class="tshadow mb25 bozero">
                                <h3 class="pagetitleh2">
                                    <?php echo $this->lang->line('address_details'); ?>
                                </h3>
                                <div class="table-responsive around10 pt0">
                                    <table class="table3 table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-5">
                                                    <?php echo $student['current_address']; ?>
                                                </td>
                                            </tr>
                                            <?php }
                            ...
                            <div class="tshadow mb25 bozero">
                                <h3 class="pagetitleh2">
                                    <?php echo $this->lang->line('parent_guardian_detail'); ?>
                                </h3>
                                <div class="table-responsive around10 pt0">
                                    <table class="table3 table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($sch_setting->father_pic) {
                                                ?>
                                            <td rowspan="3"><img
                                                    class="profile-user-img img-responsive img-rounded border0" src="             
            <?php
        ...
        "></td>
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('father_occupation'); ?>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="bordertop">
                                            ...
                                            <td rowspan="3">
                                                <?php if ($sch_setting->mother_pic) {
                                                    ?><img class="profile-user-img img-responsive img-rounded border0"
                                                    src="
        <?php
        ...
        ">
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('mother_phone'); ?>
                                            </td>
                                            <td>
                                                <?php echo $student['mother_phone']; ?>
                                            </td>
                                        </tr>
                                        <?php }
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('mother_occupation'); ?>
                                            </td>
                                            <td>
        ...
        ">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $student['guardian_email']; ?>
                                            </td>
                                        </tr>
                                        <?php }
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('guardian_relation'); ?>
                                            </td>
                                            <td>
                                                <?php echo $student['guardian_relation']; ?>
                                            </td>
                                        </tr>
                                        <?php }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $student['guardian_occupation']; ?>
                                            </td>
                                        </tr>
                                        <?php }
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $this->lang->line('guardian_address'); ?>
                                            </td>
                                            <td>
                                                <?php echo $student['guardian_address']; ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table3 table-striped table-hover tmb0">
                                        <tbody>
                                            <tr>
                                                <td width="35%">
                                                    <?php echo $this->lang->line('pick_up_point'); ?>
                                                </td>
                                                <td class="col-md-5">
                                                    <?php echo $student['pickup_point_name']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="35%">
                                                ...
                                                <td class="col-md-5">
                                                    <?php echo $student['route_title']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <?php echo $this->lang->line('vehicle_number'); ?>
                                                </td>
                                                <td>
                                                    <?php echo $student['vehicle_no']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <?php echo $student['driver_name']; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <?php echo $this->lang->line('driver_contact'); ?>
                                                </td>
                                                <td>
                                                    <?php echo $student['driver_contact']; ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="tshadow mb25  bozero">
                                <h3 class="pagetitleh2">
                                    <?php echo $this->lang->line('hostel_details') ?>
                                </h3>
                                <div class="table-responsive around10 pt0">
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table3 table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="35%">
                                                    <?php echo $this->lang->line('measurement_date'); ?>
                                                </td>
                                                <td class="col-md-5">
                                                    <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-5">
                                                    <?php echo $student['previous_school']; ?>
                                                </td>
                                            </tr>
                                            <?php }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $student['bank_account_no']; ?>
                                                </td>
                                            </tr>
                                            <?php }
                                        ...
                                        <table class="table table-striped" id="feetable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text text-right"><?php echo $this->lang->line('payment_id'); ?>
                                                    </th>
                                            ...
                                            if (empty($student_due_fee) && empty($student_discount_fee)) {
                                                ...
                                                <tbody>
                                                            ...
                                                            ?>
                                                                ...
                                                                <td class="text text-right">
                                                                    ...
                                                                    if (($fee_value->due_date != "0000-00-00" && $fee_value->due_date != null) && (strtotime($fee_value->due_date) < strtotime(date('Y-m-d')))) {
                                                                        ?>
                                                                        <span
                                                                            class="text text-danger"><?php echo " + " . amountFormat($fee_value->fine_amount); ?></span>
                                                                        <?php
                                                    ...
                                                    <tr class="box box-solid total-bg">
                                                        <td></td>
                                                        <td></td>
                                                        <td class="text text-right" colspan="2">
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <?php if ($value["created_student_id"] == $student_id) {
                                                            if ($student_timeline == 'enabled') { ?>
                                                                ...
                                                                <span class="time"><a data-toggle="tooltip"
                                                        ...
                                                        <?php if (!empty($value["document"])) { ?>
                                                            <span class="time"><a class="defaults-c text-right"
                                                                    ...
                                                                    href="<?php echo base_url() . "user/timeline/download/" . $value["id"] ?>"
                        ...
                        if (!$sch_setting->attendence_type) {
                            ...
                            <div class="tab-pane" id="attendance">
                                ...
                                <div>
                                    <div class="download_label"><?php echo $this->lang->line('attendance'); ?> of
                                                    ...
                                                    <tr>
                                                        ...
                                                        foreach ($monthlist as $monthkey => $monthvalue) {
                                                            ...
                                                            <td>
                                                                ...
                                                                if (array_key_exists($date_att, $resultlist)) {
                                                ...
                                                foreach ($student_doc as $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-date text-right">
                                                            <a href="<?php echo base_url(); ?>user/user/download/<?php echo $value['student_id'] . "/" . $value['id']; ?>"
                            ...
                            <div class="tab-pane" id="incident">
                                <div class="timeline-header no-border">
                                    <div class="mailbox-messages table-responsive overflow-visible">
                                        <div class="download_label"><?php echo $this->lang->line('student_behaviour'); ?>
                                        </div>
                                        <table class="table table-striped table-bordered table-hover example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 70px;" class="noExport">
                                                        <?php echo $this->lang->line('action'); ?>
                                                    </th>
                                                </tr>
                                            </thead>
                                                ...
                                                <?php if (empty($assignstudent)) {
                                                    ...
                                                    foreach ($assignstudent as $assignstudent_value) {
                                                        ...
                                                        <tr class="<?php echo $pointclass; ?>">
                                                            <td class="mailbox-name"> <?php echo $assignstudent_value['title'] ?>
                                                            </td>
                                                            <td class="mailbox-name"> <?php echo $assignstudent_value['point'] ?>
                                                            </td>
                                                            <td class="mailbox-name">
                                                                <?php echo $this->customlib->dateformat($assignstudent_value['created_at']) ?>
                                                            </td>
                                                            <td class="mailbox-name" style="width: 380px;">
                                                                <?php echo $assignstudent_value['description'] ?>
                                                            </td>
                                                            <td class="mailbox-name">
                                                                <?php
                                                            ...
                                                            <td class="mailbox-name">
                                                                <a class="btn btn-default btn-xs comments relative overflow-visible"
                                                                    ...
                                                                    <?php if ($assignstudent_value['totalcomments']['totalcomments'] != '0') { ?>
                                                                        <span
                                                                            class="comment-badges"><?php echo $assignstudent_value['totalcomments']['totalcomments']; ?></span><?php } ?>
                        ...
                        <div class="tab-pane" id="exam">
                            ...
                            <div class="dt-buttons btn-group pull-right miusDM40">
                                <a class="btn btn-default btn-xs dt-button no_print" id="print" onclick="printDiv()"><i
                                    ...
                                    <table class="table table-striped ptt10" id="headerTable">
                                        <thead>
                                            ...
                                            if ($exam_value->exam_type == "gpa") {
                                                ?>
                                            <th>
                                                <?php echo $this->lang->line('grade_point'); ?>
                                            </th>
                                            <th>
                                                            ...
                                                            if ($total_exams) {
                                                                if ($exam_value->exam_type == "average_passing") {
                                                                    if ($exam_value->passing_percentage <= $exam_percentage) {
                                                                        ...
                                                                        ?>
                                                            <span class='label bg-green ml-rtl'
                                                ...
                                                <h5 class="description-header">
                                                    <?php echo $this->lang->line('result'); ?> :<span
                                                        ...
                                                        <?php
                                                                ...
                                                                if ($exam_absent_status) {
                                                                    ?>
                                                        <span class='label label-danger ml-rtl'
                                                            style="margin-right: 5px;">
                                                            <?php
                                                            echo $this->lang->line('fail');
                                                            ?>
                                                ...
                                                <h5 class="description-header">
                                                    ...
                                                    <span class="description-text">
                                                        ...
                                                        if ($consolidate_exam_result == "pass") {
                                                            ?>
                                                        <span class='label label-success ml-rtl'
                                                            style="margin-right: 5px;">
                                                            <?php
                                                            echo $this->lang->line('pass');
                                                            ?>
                ...
                <form id="form1" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div id='upload_documents_hide_show'>
                        ...
                        <div class="form-group">
                            ...
                            <input id="first_title" name="first_title" placeholder="" type="text" class="form-control"
                                value="<?php echo set_value('first_title'); ?>" />
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">
                                <?php echo $this->lang->line('documents'); ?> <small class="req">*</small>
                            </label>
                            <div class="">
                                <input name="first_doc" placeholder="" type="file" class="form-control filestyle"
                                    data-height="40" value="<?php echo set_value('first_doc'); ?>" />
                                <span class="text-danger">
