                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 ">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo base_url() ?>user/user/dashboard" type="button"
                        ...
                        <div class="row no-print mb10">
                            <div class="col-md-12 mDMb10">
                                <div class="float-rtl-right float-left">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-info printSelected"
                                        data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>"><i
                                            class="fa fa-print"></i> <?php echo $this->lang->line('print_selected'); ?>
                                    </a>
                                    <?php if ($payment_method) { ?>
                                        <button type="button" class="btn btn-sm btn-warning collectSelected" id="load"
                                            data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait') ?>"><i
                                                class="fa fa-money"></i>
                                            <?php echo $this->lang->line('pay_selected') ?></button>
                                    <?php } ?>
                                    <?php
                                    if ($student_processing_fee) { ?>
                                        <a href="#" class="btn btn-sm btn-info getProcessingfees"
                                            data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait') ?>"><i
                                                class="fa fa-money"></i>
                                    ...
                                    if ($sch_setting->is_offline_fee_payment) {
                                        ?>
                                        <button class="btn btn-sm btn-info getBankPayments"
                                            data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait') ?>"><i
                                                class="fa fa-money"></i>
                                            <?php echo $this->lang->line('offline_bank_payments') ?> </button>
                                    <?php } ?>
                                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover  table-fixed-header">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align="left" class="text text-center">
                                            ...
                                            foreach ($fee->fees as $fee_key => $fee_value) {
                                                ...
                                                ?>
                                                    <td><input class="checkbox" type="checkbox" name="fee_checkbox"
                                                            ...
                                                            data-fee_category="fees" data-trans_fee_id="0"> </td>
                                                        ...
                                                        <div class="btn-group pull-right">
                                                            ...
                                                            if ($feetype_balance > 0) {
                                                                ...
                                                                if ($payment_method && $sch_setting->is_offline_fee_payment) {
                                                                    ...
                                                                    <form class="form_fees"
                                                                        action="<?php echo site_url('user/gateway/payment/pay'); ?>"
                                                                        method="POST">
                                                                        ...
                                                                        <input type="hidden" name="fee_groups_feetype_id"
                                                                        ...
                                                                        <div class="dropdown">
                                                                            <button
                                                                                class="btn btn-xs btn-primary pull-right dropdown-toggle"
                                                                            ...
                                                                            <ul class="dropdown-menu  dropdown-menu-right">
                                                                                <li><a href="javascript:void(0)"
                                                                                        onclick="submitform('online_payment',this)"><?php echo $this->lang->line('online_payment'); ?></a>
                                                                                </li>
                                                                                <li><a href="javascript:void(0)"
                                                                                        onclick="submitform('offline_payment',this)"><?php echo $this->lang->line('offline_payment'); ?></a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </form>
                                                                    ...
                                                                    <form class="form_fees"
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i
                                                                                class="fa fa-money"></i>
                                                                            <?php echo $this->lang->line('pay'); ?></button>
                                                                    </form>
                                                                    <?php
                                                        ...
                                                        if ($feetype_balance > 0) {
                                                            ...
                                                            if ($payment_method && $sch_setting->is_offline_fee_payment) {
                                                                ...
                                                                <form class="form_fees"
                                                                    ...
                                                                    <input type="hidden" name="student_transport_fee_id"
                                                                        value="<?php echo $transport_fee_value->id; ?>">
                                                                    ...
                                                                    <input type="hidden" name="submit_mode" value="">
                                                                    <div class="dropdown">
                                                                        <button class="btn btn-xs btn-primary pull-right dropdown-toggle"
                                                                            type="button" data-toggle="dropdown"><i class="fa fa-money"></i>
                                                                            <?php echo $this->lang->line('pay'); ?>
                                                                            <span class="caret"></span></button>
                                                                        <ul class="dropdown-menu  dropdown-menu-right">
                                                        ...
                                                        <div class="btn-group pull-right">
                                                            ...
                                                            if ($feetype_balance > 0) {
                                                                ...
                                                                if ($payment_method && $sch_setting->is_offline_fee_payment) {
                                                                    ...
                                                                    <form class="form_fees"
                                                                        action="<?php echo site_url('user/gateway/payment/addingpay'); ?>"
                                                                        method="POST">
                                                                        <input type="hidden" name="fee_category" value="fees">
                                                                        <input type="hidden" name="student_transport_fee_id" value="0">
                                                                        <input type="hidden" name="student_fees_master_id"
...
<script type="text/javascript">
    ...
    $(document).on('click', '.adding_printDoc', function () {
        ...
        $.ajax({
            url: base_url + 'user/user/printaddingFeesByName',
            type: 'post',
            dataType: "JSON",
            data: { 'fee_category': fee_category, 'student_session_id': student_session_id, 'main_invoice': main_invoice, 'sub_invoice': sub_invoice},
            success: function (response) {
