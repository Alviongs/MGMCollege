...
echo $app_name[0]['name'];?></h6>
            ...
            <form id="login-form" action="<?php echo site_url('site/userlogin') ?>" method="post" accept-charset="utf-8" >
            <?php echo $this->customlib->getCSRF(); ?>
                ...
                <!-- <?php if($is_captcha){ ?>
                      <div class="g-recaptcha" data-sitekey="6LerqigqAAAAAPJIBYLn72HE89ldPa3QjixYgyhe" data-callback="onRecaptchaSuccess" data-error="recaptcha-error"></div>

                      <div id="recaptcha-error" class="text-danger" style="display: none;">Please complete the CAPTCHA.</div>
                <?php } ?> -->
    ...
    <script>
      function onRecaptchaSuccess() {
        // Hide the error message when reCAPTCHA is successfully completed
      ...
      document.getElementById('login-form').addEventListener('submit', function(event) {
        ...
        if (recaptchaResponse.length === 0) {
          // Prevent form submission and show the error message if reCAPTCHA is not completed
