...
<body>
  ...
  <div class="login-container">
    ...
    <form method="POST" class="form login" action="<?php echo site_url('site/userlogin') ?>">
      ...
      <div class="login-actions-container">
        ...
        <a class="forgot-password" href="<?php echo site_url('site/ufpassword') ?>">Forgot Password?</a>
